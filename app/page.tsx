            ...
            <div className="m-auto">
              <CardContent className=" items-center justify-center ">
                ...
                <p className="text-lg text-gray-600">
                  ¿Eres administrador de propiedad horizontal y pierdes tiempo
                  redactando actas? Con nuestro{" "}
            ...
            <div className="mx-auto max-w-2xl lg:max-w-none">
              <div className="text-center">
                ...
                <p className="mt-4 text-lg/8 text-gray-600">
                  Con tan solo 4 pasos, tendrás lista tu acta formal, ideal para
                  reuniones realizadas por plataformas como Teams, Zoom y Google
                  Meet.
                </p>
              </div>
              <dl className="mt-5 grid grid-cols-1 gap-0.5 overflow-hidden rounded-md  sm:grid-cols-2 lg:grid-cols-4">
                <div className="flex flex-col bg-[#5A2D8E] p-8">
                  <dt className="text-sm  text-gray-300">
                    ...
                    Carga fácilmente grabaciones en formatos compatibles como
                    MP3, M4A, MP4, MOV, entre otros
                  </dt>
                ...
                <div className="flex flex-col bg-[#5A2D8E] p-8">
                  <dt className="text-sm  text-gray-300">
                    ...
                    seguras con tarjetas, transferencias bancarias o pagos en
                    efectivo
                  </dt>
                  <dd className="order-first text-3xl font-semibold tracking-tight text-white">
                    <svg
                ...
                <div className="flex flex-col bg-[#5A2D8E] p-8">
                  <dt className="text-sm  text-gray-300">
                    ...
                    Gracias a la avanzada inteligencia artificial, transformamos
                    tu grabación en una transcripción completa y en una pre-acta
                    editable que incluye los puntos clave y los elementos de
                ...
                <div className="flex flex-col bg-[#5A2D8E] p-8">
                  <dt className="text-sm  text-gray-300">
                    ...
                    Obtendrás todo el audio pasado a texto en la transcripción y
                    la pre-acta en un documento profesional que te permitirá
                    ajustar los detalles necesarios y cumplir con la normativa
                    legal de Colombia.
                  </dt>
                  <dd className="order-first text-3xl font-semibold tracking-tight text-white">
                    <svg
            ...
            <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
              <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
                ...
                <blockquote className="text-xl/8 mt-5  text-gray-600 ">
                  <p>
                    El proceso puede tardar entre 3 y 10 minutos, dependiendo de
                    la duración y la calidad del audio
                  </p>
                </blockquote>
              </div>
                ...
                <div className="lg:max-w-lg">
                  ...
                  <dl className="mt-10 max-w-xl space-y-8 text-base/7 text-gray-600 lg:max-w-none">
                    <div className="relative pl-9">
                      ...
                      <dd className="inline">
                        Usa grabaciones claras, incluso de reuniones en tiempo
                        real realizadas en Zoom, Microsoft Teams o similares
                      </dd>
                    </div>
                  </dl>
                  <dl className="mt-10 max-w-xl space-y-8 text-base/7 text-gray-600 lg:max-w-none">
                    <div className="relative pl-9">
                      ...
                      <dd className="inline">Asegura una conexión estable</dd>
                    </div>
                  </dl>
                  <dl className="mt-10 max-w-xl space-y-8 text-base/7 text-gray-600 lg:max-w-none">
                    <div className="relative pl-9">
                ...
                <div className="lg:max-w-lg">
                  ...
                  <dl className="mt-10 max-w-xl space-y-8 text-base/7 text-gray-600 lg:max-w-none">
                    <div className="relative pl-9">
                      ...
                      <dd className="inline">
                        Seguridad garantizada: Utilizamos plataformas como Wompi
                        y Bancolombia
                      </dd>
                    </div>
                  </dl>
                ...
                <div className="lg:max-w-lg">
                  ...
                  <dl className="mt-10 max-w-xl space-y-8 text-base/7 text-gray-600 lg:max-w-none">
                    <div className="relative pl-9">
                      ...
                      <dd className="inline">
                        Cumplimos con la Ley 1581 de 2012 para la protección de
                        datos y privacidad en Colombia
                      </dd>
                    </div>
                  </dl>
                </div>
        ...
        <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-7xl text-pretty text-lg/8 text-gray-300">
              ...
              editables, listas para ser el soporte perfecto de tus decisiones.
            </p>
