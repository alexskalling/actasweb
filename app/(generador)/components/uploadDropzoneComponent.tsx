...
export default function UploadDropzoneComponent({ accept, isIOS, onChange }: UploadDropzoneProps) {
  return (
      ...
      >
        <div className="flex flex-col items-center justify-center pt-5 pb-6">
          ...
          <p className="mb-2 text-sm text-purple-700">
            <span className="font-semibold">Haz click para seleccionar un archivo</span>
          </p>
          {isIOS && (
        ...
        <input
          ...
          type="file"
          className="hidden"
          accept={isIOS ? "audio/*,video/*,.m4a,.mp3,.wav,.mp4,.mov,.aac,.ogg" : accept}
          onChange={onChange}
