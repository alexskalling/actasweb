      ...
      <main className="bg-gray-50 min-h-screen">
        <div className="mx-auto max-w-7xl px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-12 lg:items-stretch gap-4 sm:gap-6 lg:gap-8">
            ...
            {/* 1. Tarjeta de Perfil de Usuario (Ocupa todo el ancho arriba) */}
            ...
            {/* Historial Component - Ocupa 8 columnas de 12 */}
          ...
          {/* Sección Inferior (Tips, Reviews, Referidos) - Fuera del grid principal */}
          <div className="mt-8">
            <BottomSection />
          </div>
        </div>
